        ...
        <div>
            ...
            <div className="row">
                ...
                <div className="col-lg-9 sdp tp" style={{ minHeight: 1000 }}>
                    <div className="box">
                        <div className="name">
                            <i className="bi bi-house-door-fill" />Thông tin hoá đơn phòng
                        </div>
                        <div className="form-add row">
                            <div className="col-md-3">
                                <div className="icon">
                                    <img src="../../public/image/icon/room.png" alt className="object" />
                                </div>
                            </div>
                            <form action method="post" className="col-md-7">
                                <div className="row">
                                    <div className="col-md-3">
                                        <label htmlFor="exampleFormControlInput1" className="form-label">Hoá đơn:</label>
                                        <input type="text" className="form-control" id="exampleFormControlInput1" defaultValue="Phòng" required readOnly />
                                    </div>
                                    ...
                                    <div className="col-md-3">
                                        <label htmlFor="exampleFormControlInput1" className="form-label">Sinh viên: </label>
                                        <input type="text" className="form-control" id="exampleFormControlInput1" defaultValue required readOnly />
                                    </div>
                                </div>
                                <div className="row">
                                    <div className="col-md-3">
                                        <label htmlFor="exampleFormControlInput1" className="form-label">Giá phòng:</label>
                                        <input type="number" className="form-control" id="giaphong" name="giaphong" defaultValue required />
                                    </div>
                                    <div className="col-md-3">
                                        <label htmlFor="exampleFormControlInput1" className="form-label">Vệ sinh:</label>
                                        <input type="number" className="form-control" id="vesinh" name="vesinh" defaultValue required />
                                    </div>
                                    <div className="col-md-3">
                                        <label htmlFor="exampleFormControlInput1" className="form-label">Tổng tiền:</label>
                                        <input type="text" className="form-control" id="tongtien" defaultValue required readOnly />
                                    </div>
                                </div>
                                <div className="row">
                                ...
                                <input type="submit" className="btn d-inline-block bgr-ok" onclick="return confirm('Xác nhận chỉnh sửa')" defaultValue="Sửa" name="sua" />
                            </form>
                        </div>
                    </div>
                </div>
