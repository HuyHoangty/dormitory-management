...
function RequestDetail_Changeroom() {
  return (
    <div>
        ...
        <div className="p-4 sm:p-6 space-y-4 sm:space-y-6">
          <div className="flex h-full">
            <main className="w-full p-8">
              ...
              <div className="mb-4">
                <a href="#" className="text-blue-500 pb-2">Yêu cầu đổi phòng</a>
              </div>
              <div className="bg-gray-200 p-6 rounded-lg shadow-md">
                ...
                <p>Sau một thời gian sinh hoạt tại phòng 113-CA, tôi nhận thấy điều kiện học tập và sinh hoạt chưa thực sự tốt. Tôi có một người bạn tại phòng 115-BV, người mà tôi đã quen biết và cùng học chung học phần. Việc chuyển sang phòng 115-BV sẽ giúp tôi có thêm sự hỗ trợ trong việc học tập, trao đổi bài vở và tạo môi trường học tập hiệu quả hơn. Vì vậy, tôi kính mong Ban Quản lý xem xét và chấp thuận đơn xin đổi phòng của tôi.</p>
...
export default RequestDetail_Changeroom;