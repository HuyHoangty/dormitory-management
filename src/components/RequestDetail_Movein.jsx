    ...
    return (
        ...
        <div className="flex h-full">
                    <main className="w-full p-8">
                        ...
                        <div className="mb-4">
                            <a href="#" className="text-blue-500 pb-2">Yêu cầu gia nhập ký túc xá</a>
                        </div>
                        <div className="bg-gray-200 p-6 rounded-lg shadow-md">
                            <p><strong>Họ và tên:</strong> Nguyễn Văn A</p>
                            <p><strong>Ngày sinh:</strong> 01/01/2003</p>
                            <p><strong>Giới tính:</strong> Nam</p>
                            <p><strong>Dân tộc:</strong> Kinh</p>
                            <p><strong>Tôn giáo:</strong> Không</p>
                            <p><strong>Chuyên ngành:</strong> CNTT</p>
                            <p><strong>Lớp:</strong> K66CB</p>
                            <p><strong>Mã sinh viên:</strong> 12345678</p>
                            <p><strong>Số phòng:</strong> 113-CA</p>
                            <p><strong>Số điện thoại:</strong> 0987654321</p>
                            <p><strong>Lý do:</strong></p>
                            <p>Yêu cầu gia nhập ký túc xá</p>
                ...
                export default RequestDetail_Movein;