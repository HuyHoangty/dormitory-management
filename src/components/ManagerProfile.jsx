            ...
            <header className="sticky top-0 inset-x-0 flex flex-wrap md:justify-start md:flex-nowrap z-[48] w-full bg-white border-b text-sm py-2.5 lg:ps-[260px] dark:bg-neutral-800 dark:border-neutral-700">
                <nav className="px-4 sm:px-6 flex basis-full items-center w-full mx-auto">
                    <div className="me-5 lg:me-0 lg:hidden">
                        ...
                        <a className="flex-none rounded-md text-xl inline-block font-semibold focus:outline-none focus:opacity-80" href="/request-management" aria-label="Quản lý">
                    ...
                    <div className="h-full overflow-y-auto [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar-thumb]:bg-gray-300 dark:[&::-webkit-scrollbar-track]:bg-neutral-700 dark:[&::-webkit-scrollbar-thumb]:bg-neutral-500">
                        <nav className="hs-accordion-group p-3 w-full flex flex-col flex-wrap" data-hs-accordion-always-open>
                            <ul className="flex flex-col space-y-1">
                                ...
                                <li><a className="w-full flex items-center gap-x-3.5 py-2 px-2.5 text-sm text-gray-800 rounded-lg hover:bg-gray-100 dark:hover:bg-neutral-700 dark:text-neutral-200 dark:hover:text-neutral-300" href="/manager-profile">
            ...
            <div className="w-full lg:ps-64">
                <div className="p-4 sm:p-6 space-y-4 sm:space-y-6">
                    <div className="flex h-full">
                        <main className="w-full ml-1/5 p-6 content">
                                    ...
                                    <div className="bg-white shadow-xl rounded-lg p-6">
                                        <div className="flex flex-col border-b py-4 sm:flex-row sm:items-start">
                                            <div className="shrink-0 mr-auto sm:py-3">
                                                <p className="text-2xl font-medium">Thông tin người dùng</p>
                                        ...
                                        <div className="flex flex-col gap-4 border-b py-4 sm:flex-row">
                                            ...
                                            <div className="flex h-56 w-full flex-col items-center justify-center gap-4 rounded-xl p-5 text-center">
                                                <img src="https://placehold.co/50x50" alt="User avatar" className="h-16 w-16 rounded-full" />
                                        ...
                                        <div className="flex flex-col gap-4 border-b  py-4 sm:flex-row">
                                            <p className="shrink-0 w-32 font-medium">Ngày sinh</p>
                                            <input className="w-full rounded-md border bg-white px-2 py-2 outline-none ring-blue-600 focus:ring-1" />
                                        </div>
                                        <div className="flex flex-col gap-4 border-b  py-4 sm:flex-row">
                                        ...
                                        <div className="flex flex-col gap-4 mb-5 py-4 sm:flex-row">
                                            <p className="shrink-0 w-32 font-medium">Địa chỉ</p>
                                            <input className="w-full rounded-md border bg-white px-2 py-2 outline-none ring-blue-600 focus:ring-1" />
                                        </div>
                                        <button className="hidden border-2 border-transparent bg-blue-500 text-white px-8 py-2 rounded-full font-medium shadow-lg sm:inline focus:outline-none focus:ring hover:bg-blue-700">Lưu</button>


                                    </div>
                                </div>
                                <div className="col-span-4 sm:col-span-5">
                                    <div className="bg-white shadow-xl rounded-lg ml-10 p-6">
                                        <div className="flex flex-col border-b py-4 sm:flex-row sm:items-start">
                                            <div className="shrink-0 mr-auto sm:py-3">
                                        ...
                                        <div className="flex flex-col gap-4 py-4 mb-5 sm:flex-row">
                                            <p className="shrink-0 w-32 font-medium">Mật khẩu</p>
                                            <input className="w-full rounded-md border bg-white px-2 py-2 outline-none ring-blue-600 focus:ring-1" />
                                        </div>
