...
function RequestDetail_Moveout() {
    return (
        <div>
        ...
        <div className="flex h-full">
                    <main className="w-full p-8">
                        <h1 className="text-2xl font-semibold mb-4">Quản lý yêu cầu</h1>
                        <div className="mb-4">
                            <a href="#" className="text-blue-500 pb-2">Yêu cầu ra khỏi ký túc xá</a>
                        </div>
                        <div className="bg-gray-200 p-6 rounded-lg shadow-md">
                            <p><strong>Họ và tên:</strong> Nguyễn Văn A</p>
                            <p><strong>Mã sinh viên:</strong> 12345678</p>
                            <p><strong>Số phòng:</strong> 113-CA</p>
                            <p><strong>Số điện thoại:</strong> 0987654321</p>
                            <p><strong>Lý do:</strong></p>
                            <p>Sau một thời gian sinh sống tại đây, tôi nhận thấy điều kiện sinh hoạt không còn phù hợp với nhu cầu cá nhân. Tôi mong muốn có một không gian sống riêng tư hơn để tiện cho việc học tập và sinh hoạt hàng ngày. Hơn nữa, việc chuyển ra ngoài cũng giúp tôi quản lý thời gian và lịch trình cá nhân một cách linh hoạt hơn. Vì vậy, tôi kính mong Ban Quản lý xem xét và chấp thuận đơn xin ra khỏi ký túc xá của tôi.</p>
                ...
                export default RequestDetail_Moveout;