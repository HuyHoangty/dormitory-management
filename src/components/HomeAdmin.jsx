                ...
                <div className="p-4 sm:p-6 space-y-4 sm:space-y-6">
                    <div className="flex h-full">
                        <main className="w-full p-6">
                            <h1 className="text-2xl font-bold mb-6">Quản lý các phòng</h1>
                                ...
                                <table className="w-full border-collapse">
                                    <thead>
                                        <tr className="text-left text-gray-500">
                                            ...
                                            <th className="py-2 px-4">Số lượng tối đa</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        {requests && requests.length > 0 ? (
                                            requests.map((item, index) => (
                                                <tr key={index} className="border-t">
                                                    <td className="py-8 px-4">{item?.room_number}</td>
                                                    <td className="py-8 px-4">144 Xuân Thủy, Cầu Giấy</td>
                                                    <td className="py-8 px-4">{item?.capacity}</td>
                                                </tr>
                                            ))
                                        ) : (
                                            <tr>
